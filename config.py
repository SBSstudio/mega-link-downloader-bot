...
class Config(object):
    ...
    APP_ID = int(os.environ.get("APP_ID", 3283847)) # Get this value from https://my.telegram.org/apps
    #If deploying on vps edit the above value as example := APP_ID = Your-APP_ID-without-inverted-commas
    
    API_HASH = os.environ.get("API_HASH" "432c6eebf8df924b27be598c295c3692") # Get this value from https://my.telegram.org/apps
    ...
    OWNER_ID = os.environ.get("OWNER_ID", 1204352805) # Your(owner's) telegram id
